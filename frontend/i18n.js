...
(function () {
    ...
    const dict = {
        ...
        translateInsights:{ en: 'Translate to Arabic',   ar: 'ترجمة إلى الإنجليزية' },
        legendTitle:      { en: 'Understanding the Indicators', ar: 'فهم المؤشرات' },
        legendGreenDot:   { en: 'Green Dot',             ar: 'النقطة الخضراء' },
        legendGreenDotDesc:{ en: 'Indicates a positive or stable metric. The insight in this card reflects normal or healthy business performance.', ar: 'تشير إلى مؤشر إيجابي أو مستقر. الرؤية في هذه البطاقة تعكس أداء أعمال طبيعي أو صحي.' },
        legendRedDot:     { en: 'Red Dot',               ar: 'النقطة الحمراء' },
        legendRedDotDesc: { en: 'Indicates a risk or warning. The insight in this card highlights potential issues or negative trends that require attention.', ar: 'تشير إلى خطر أو تحذير. الرؤية في هذه البطاقة تسلط الضوء على مشاكل محتملة أو اتجاهات سلبية تتطلب الانتباه.' },
        legendHigh:       { en: 'High Confidence',       ar: 'ثقة عالية' },
        legendHighDesc:   { en: 'The AI generated a detailed and comprehensive insight with strong data support. The analysis is thorough and reliable.', ar: 'أنشأ الذكاء الاصطناعي رؤية مفصلة وشاملة مع دعم بيانات قوي. التحليل شامل وموثوق.' },
        legendMedium:     { en: 'Medium Confidence',     ar: 'ثقة متوسطة' },
        legendMediumDesc: { en: 'The AI provided a moderate-length insight. The data may be partially available or the pattern is not fully clear.', ar: 'قدم الذكاء الاصطناعي رؤية متوسطة الطول. قد تكون البيانات متاحة جزئياً أو النمط غير واضح تماماً.' },
        legendLow:        { en: 'Low Confidence',        ar: 'ثقة منخفضة' },
        legendLowDesc:    { en: 'The AI generated a brief or limited insight. The available data may be insufficient for a detailed analysis.', ar: 'أنشأ الذكاء الاصطناعي رؤية موجزة أو محدودة. قد تكون البيانات المتاحة غير كافية لتحليل مفصل.' },
